...
We provide a `preprocess/` folder to generate and organize **2D masks** and **camera parameters (JSON)**, which can be directly imported into this fork (e.g., for the Mask-to-3D workflow).
